...
<?php 
  function have_posts(){
    echo("this function is prebuilt in wordpress. tells the while to keep looping as long as we still have posts to loop through");
  }
  function the_title(){
    echo("Also a prebuilt function in wordpress. It gets the title for each post");
  }
  function the_post(){
    echo("Also a prebuilt function in wordpress. It keeps track of the posts we are currently working with. It will tell wordpress to get all the relevant information about the next post ready for us to use");
  }
  function the_content(){
    echo("Also a prebuilt function in wordpress. It is for the body ");
  }
 while(have_posts()) {
  the_post(); ?>
...
<?php 
  function get_header(){
    echo "This function will pull off the contents in header.php into index.php";
  }
  get_header();
?>
<div class="page-banner">
  ...
  <?php 
  function get_footer(){
    echo "pulls off the contents in footer.php";
  }
    get_footer()
  ?>